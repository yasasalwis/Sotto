...
enum AppLinks {
    ...
    static let generatedContentNotice = """
        ...
        produce text you did not want. Nothing they write is checked by anyone, and none of it \
        is medical, legal or financial advice. Treat an answer as a draft and verify anything \
        that matters.
        """
